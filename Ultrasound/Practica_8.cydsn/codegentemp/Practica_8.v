// ======================================================================
// Practica_8.v generated from TopDesign.cysch
// 08/23/2021 at 13:21
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("56fd728b-50be-47e4-8154-7ed0da7fc287/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Ultrasonido_net;
	wire [0:0] tmpIO_0__Ultrasonido_net;
	wire [0:0] tmpINTERRUPT_0__Ultrasonido_net;
	electrical [0:0] tmpSIOVREF__Ultrasonido_net;

	cy_psoc3_pins_v1_10
		#(.id("2e835934-11ea-4d5b-9814-7cac79a8f557"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Ultrasonido
		 (.oe(tmpOE__Ultrasonido_net),
		  .y({1'b0}),
		  .fb({Net_13}),
		  .io({tmpIO_0__Ultrasonido_net[0:0]}),
		  .siovref(tmpSIOVREF__Ultrasonido_net),
		  .interrupt({tmpINTERRUPT_0__Ultrasonido_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ultrasonido_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Boton_1_net;
	wire [0:0] tmpIO_0__Boton_1_net;
	wire [0:0] tmpINTERRUPT_0__Boton_1_net;
	electrical [0:0] tmpSIOVREF__Boton_1_net;

	cy_psoc3_pins_v1_10
		#(.id("1d1b7395-fe0a-4701-9ddb-147a0342ff12"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Boton_1
		 (.oe(tmpOE__Boton_1_net),
		  .y({1'b0}),
		  .fb({Net_66}),
		  .io({tmpIO_0__Boton_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Boton_1_net),
		  .interrupt({tmpINTERRUPT_0__Boton_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Boton_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Boton_2_net;
	wire [0:0] tmpIO_0__Boton_2_net;
	wire [0:0] tmpINTERRUPT_0__Boton_2_net;
	electrical [0:0] tmpSIOVREF__Boton_2_net;

	cy_psoc3_pins_v1_10
		#(.id("51cca79d-5f45-46e0-b33b-2800d101bf66"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Boton_2
		 (.oe(tmpOE__Boton_2_net),
		  .y({1'b0}),
		  .fb({Net_84}),
		  .io({tmpIO_0__Boton_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Boton_2_net),
		  .interrupt({tmpINTERRUPT_0__Boton_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Boton_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("80d61d33-78ed-48b4-a3a7-be177175ec3d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ef26e2f7-4346-4082-a234-9a4270d536dc"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
