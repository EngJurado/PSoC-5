...
extern void variables_Set(uint8 channel);
extern void variables_Unset(uint8 channel);
/* variables__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE variables__addrTable[6];
/* variables__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE variables__maskTable[6];
