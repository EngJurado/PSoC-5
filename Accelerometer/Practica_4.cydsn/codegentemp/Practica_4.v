// ======================================================================
// Practica_4.v generated from TopDesign.cysch
// 05/02/2021 at 19:49
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c334262-6476-4a1e-8c76-6653626bc2c4/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("47d99fb6-258e-401b-a024-23aad310832b/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Vz_net;
	wire [0:0] tmpFB_0__Vz_net;
	wire [0:0] tmpIO_0__Vz_net;
	wire [0:0] tmpINTERRUPT_0__Vz_net;
	electrical [0:0] tmpSIOVREF__Vz_net;

	cy_psoc3_pins_v1_10
		#(.id("0d69229c-cf86-41ab-b1f0-fa336549cadf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Vz
		 (.oe(tmpOE__Vz_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vz_net[0:0]}),
		  .analog({Net_17}),
		  .io({tmpIO_0__Vz_net[0:0]}),
		  .siovref(tmpSIOVREF__Vz_net),
		  .interrupt({tmpINTERRUPT_0__Vz_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vz_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCD_v2_20_0 LCD ();

	wire [0:0] tmpOE__Vy_net;
	wire [0:0] tmpFB_0__Vy_net;
	wire [0:0] tmpIO_0__Vy_net;
	wire [0:0] tmpINTERRUPT_0__Vy_net;
	electrical [0:0] tmpSIOVREF__Vy_net;

	cy_psoc3_pins_v1_10
		#(.id("bf2085d2-2d31-44b5-a84a-bbbf4c80bc5c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Vy
		 (.oe(tmpOE__Vy_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vy_net[0:0]}),
		  .analog({Net_87}),
		  .io({tmpIO_0__Vy_net[0:0]}),
		  .siovref(tmpSIOVREF__Vy_net),
		  .interrupt({tmpINTERRUPT_0__Vy_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vy_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Vx_net;
	wire [0:0] tmpFB_0__Vx_net;
	wire [0:0] tmpIO_0__Vx_net;
	wire [0:0] tmpINTERRUPT_0__Vx_net;
	electrical [0:0] tmpSIOVREF__Vx_net;

	cy_psoc3_pins_v1_10
		#(.id("8232c57b-b6bc-4244-9f5b-aa58f21194d5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Vx
		 (.oe(tmpOE__Vx_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vx_net[0:0]}),
		  .analog({Net_16}),
		  .io({tmpIO_0__Vx_net[0:0]}),
		  .siovref(tmpSIOVREF__Vx_net),
		  .interrupt({tmpINTERRUPT_0__Vx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- AMux variables start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 variables(
        .muxin({
            Net_17,
            Net_87,
            Net_16
    ...
    defparam variables.muxin_width = 3;
    defparam variables.init_mux_sel = 3'h0;
    defparam variables.one_active = 0;
    defparam variables.connect_mode = 1;
