...
/* Vx */
#define Vx__0__INTTYPE CYREG_PICU1_INTTYPE7
#define Vx__0__MASK 0x80u
#define Vx__0__PC CYREG_PRT1_PC7
#define Vx__0__PORT 1u
#define Vx__0__SHIFT 7u
#define Vx__AG CYREG_PRT1_AG
#define Vx__AMUX CYREG_PRT1_AMUX
#define Vx__BIE CYREG_PRT1_BIE
#define Vx__BIT_MASK CYREG_PRT1_BIT_MASK
#define Vx__BYP CYREG_PRT1_BYP
#define Vx__CTL CYREG_PRT1_CTL
#define Vx__DM0 CYREG_PRT1_DM0
#define Vx__DM1 CYREG_PRT1_DM1
#define Vx__DM2 CYREG_PRT1_DM2
#define Vx__DR CYREG_PRT1_DR
#define Vx__INP_DIS CYREG_PRT1_INP_DIS
#define Vx__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Vx__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Vx__LCD_EN CYREG_PRT1_LCD_EN
#define Vx__MASK 0x80u
#define Vx__PORT 1u
#define Vx__PRT CYREG_PRT1_PRT
#define Vx__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Vx__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Vx__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Vx__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Vx__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Vx__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Vx__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Vx__PS CYREG_PRT1_PS
#define Vx__SHIFT 7u
#define Vx__SLW CYREG_PRT1_SLW

/* Vy */
#define Vy__0__INTTYPE CYREG_PICU1_INTTYPE6
#define Vy__0__MASK 0x40u
#define Vy__0__PC CYREG_PRT1_PC6
#define Vy__0__PORT 1u
#define Vy__0__SHIFT 6u
#define Vy__AG CYREG_PRT1_AG
#define Vy__AMUX CYREG_PRT1_AMUX
#define Vy__BIE CYREG_PRT1_BIE
#define Vy__BIT_MASK CYREG_PRT1_BIT_MASK
#define Vy__BYP CYREG_PRT1_BYP
#define Vy__CTL CYREG_PRT1_CTL
#define Vy__DM0 CYREG_PRT1_DM0
#define Vy__DM1 CYREG_PRT1_DM1
#define Vy__DM2 CYREG_PRT1_DM2
#define Vy__DR CYREG_PRT1_DR
#define Vy__INP_DIS CYREG_PRT1_INP_DIS
#define Vy__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Vy__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Vy__LCD_EN CYREG_PRT1_LCD_EN
#define Vy__MASK 0x40u
#define Vy__PORT 1u
#define Vy__PRT CYREG_PRT1_PRT
#define Vy__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Vy__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Vy__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Vy__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Vy__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Vy__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Vy__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Vy__PS CYREG_PRT1_PS
#define Vy__SHIFT 6u
#define Vy__SLW CYREG_PRT1_SLW

/* Vz */
#define Vz__0__INTTYPE CYREG_PICU1_INTTYPE5
#define Vz__0__MASK 0x20u
#define Vz__0__PC CYREG_PRT1_PC5
#define Vz__0__PORT 1u
#define Vz__0__SHIFT 5u
#define Vz__AG CYREG_PRT1_AG
#define Vz__AMUX CYREG_PRT1_AMUX
#define Vz__BIE CYREG_PRT1_BIE
#define Vz__BIT_MASK CYREG_PRT1_BIT_MASK
#define Vz__BYP CYREG_PRT1_BYP
#define Vz__CTL CYREG_PRT1_CTL
#define Vz__DM0 CYREG_PRT1_DM0
#define Vz__DM1 CYREG_PRT1_DM1
#define Vz__DM2 CYREG_PRT1_DM2
#define Vz__DR CYREG_PRT1_DR
#define Vz__INP_DIS CYREG_PRT1_INP_DIS
#define Vz__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Vz__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Vz__LCD_EN CYREG_PRT1_LCD_EN
#define Vz__MASK 0x20u
#define Vz__PORT 1u
#define Vz__PRT CYREG_PRT1_PRT
#define Vz__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Vz__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Vz__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Vz__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Vz__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Vz__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Vz__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Vz__PS CYREG_PRT1_PS
#define Vz__SHIFT 5u
#define Vz__SLW CYREG_PRT1_SLW
...
#define CY_PROJECT_NAME "Practica_4"
