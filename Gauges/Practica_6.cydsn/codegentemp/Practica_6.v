// ======================================================================
// Practica_6.v generated from TopDesign.cysch
// 07/19/2021 at 22:29
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d03293c8-48ab-49eb-93a4-0c8c7a667516/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__ADSK_net;
	wire [0:0] tmpFB_0__ADSK_net;
	wire [0:0] tmpIO_0__ADSK_net;
	wire [0:0] tmpINTERRUPT_0__ADSK_net;
	electrical [0:0] tmpSIOVREF__ADSK_net;

	cy_psoc3_pins_v1_10
		#(.id("c0ab6467-346f-434f-b99f-d50f085bd9af"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		ADSK
		 (.oe(tmpOE__ADSK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADSK_net[0:0]}),
		  .io({tmpIO_0__ADSK_net[0:0]}),
		  .siovref(tmpSIOVREF__ADSK_net),
		  .interrupt({tmpINTERRUPT_0__ADSK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADSK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ADDO_net;
	wire [0:0] tmpFB_0__ADDO_net;
	wire [0:0] tmpIO_0__ADDO_net;
	wire [0:0] tmpINTERRUPT_0__ADDO_net;
	electrical [0:0] tmpSIOVREF__ADDO_net;

	cy_psoc3_pins_v1_10
		#(.id("2a4e219c-977c-4348-8ab8-8534a8539499"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		ADDO
		 (.oe(tmpOE__ADDO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADDO_net[0:0]}),
		  .io({tmpIO_0__ADDO_net[0:0]}),
		  .siovref(tmpSIOVREF__ADDO_net),
		  .interrupt({tmpINTERRUPT_0__ADDO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADDO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
