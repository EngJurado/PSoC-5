...
/* ADDO */
#define ADDO__0__INTTYPE CYREG_PICU1_INTTYPE6
#define ADDO__0__MASK 0x40u
#define ADDO__0__PC CYREG_PRT1_PC6
#define ADDO__0__PORT 1u
#define ADDO__0__SHIFT 6u
#define ADDO__AG CYREG_PRT1_AG
#define ADDO__AMUX CYREG_PRT1_AMUX
#define ADDO__BIE CYREG_PRT1_BIE
#define ADDO__BIT_MASK CYREG_PRT1_BIT_MASK
#define ADDO__BYP CYREG_PRT1_BYP
#define ADDO__CTL CYREG_PRT1_CTL
#define ADDO__DM0 CYREG_PRT1_DM0
#define ADDO__DM1 CYREG_PRT1_DM1
#define ADDO__DM2 CYREG_PRT1_DM2
#define ADDO__DR CYREG_PRT1_DR
#define ADDO__INP_DIS CYREG_PRT1_INP_DIS
#define ADDO__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define ADDO__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define ADDO__LCD_EN CYREG_PRT1_LCD_EN
#define ADDO__MASK 0x40u
#define ADDO__PORT 1u
#define ADDO__PRT CYREG_PRT1_PRT
#define ADDO__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define ADDO__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define ADDO__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define ADDO__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define ADDO__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define ADDO__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define ADDO__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define ADDO__PS CYREG_PRT1_PS
#define ADDO__SHIFT 6u
#define ADDO__SLW CYREG_PRT1_SLW

/* ADSK */
#define ADSK__0__INTTYPE CYREG_PICU1_INTTYPE7
#define ADSK__0__MASK 0x80u
#define ADSK__0__PC CYREG_PRT1_PC7
#define ADSK__0__PORT 1u
#define ADSK__0__SHIFT 7u
#define ADSK__AG CYREG_PRT1_AG
#define ADSK__AMUX CYREG_PRT1_AMUX
#define ADSK__BIE CYREG_PRT1_BIE
#define ADSK__BIT_MASK CYREG_PRT1_BIT_MASK
#define ADSK__BYP CYREG_PRT1_BYP
#define ADSK__CTL CYREG_PRT1_CTL
#define ADSK__DM0 CYREG_PRT1_DM0
#define ADSK__DM1 CYREG_PRT1_DM1
#define ADSK__DM2 CYREG_PRT1_DM2
#define ADSK__DR CYREG_PRT1_DR
#define ADSK__INP_DIS CYREG_PRT1_INP_DIS
#define ADSK__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define ADSK__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define ADSK__LCD_EN CYREG_PRT1_LCD_EN
#define ADSK__MASK 0x80u
#define ADSK__PORT 1u
#define ADSK__PRT CYREG_PRT1_PRT
#define ADSK__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define ADSK__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define ADSK__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define ADSK__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define ADSK__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define ADSK__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define ADSK__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define ADSK__PS CYREG_PRT1_PS
#define ADSK__SHIFT 7u
#define ADSK__SLW CYREG_PRT1_SLW

/* Boton */
#define Boton__0__INTTYPE CYREG_PICU0_INTTYPE7
#define Boton__0__MASK 0x80u
#define Boton__0__PC CYREG_PRT0_PC7
#define Boton__0__PORT 0u
#define Boton__0__SHIFT 7u
...
/* isr_Tarado */
#define isr_Tarado__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define isr_Tarado__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define isr_Tarado__INTC_MASK 0x01u
#define isr_Tarado__INTC_NUMBER 0u
#define isr_Tarado__INTC_PRIOR_NUM 7u
#define isr_Tarado__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define isr_Tarado__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define isr_Tarado__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "Practica_6"
