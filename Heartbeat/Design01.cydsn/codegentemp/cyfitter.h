...
/* Ref */
#define Ref__0__INTTYPE CYREG_PICU0_INTTYPE7
#define Ref__0__MASK 0x80u
#define Ref__0__PC CYREG_PRT0_PC7
#define Ref__0__PORT 0u
#define Ref__0__SHIFT 7u
...
/* Entrada */
#define Entrada__0__INTTYPE CYREG_PICU3_INTTYPE3
#define Entrada__0__MASK 0x08u
#define Entrada__0__PC CYREG_PRT3_PC3
#define Entrada__0__PORT 3u
#define Entrada__0__SHIFT 3u
#define Entrada__AG CYREG_PRT3_AG
#define Entrada__AMUX CYREG_PRT3_AMUX
#define Entrada__BIE CYREG_PRT3_BIE
#define Entrada__BIT_MASK CYREG_PRT3_BIT_MASK
#define Entrada__BYP CYREG_PRT3_BYP
#define Entrada__CTL CYREG_PRT3_CTL
#define Entrada__DM0 CYREG_PRT3_DM0
#define Entrada__DM1 CYREG_PRT3_DM1
#define Entrada__DM2 CYREG_PRT3_DM2
#define Entrada__DR CYREG_PRT3_DR
#define Entrada__INP_DIS CYREG_PRT3_INP_DIS
#define Entrada__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define Entrada__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define Entrada__LCD_EN CYREG_PRT3_LCD_EN
#define Entrada__MASK 0x08u
#define Entrada__PORT 3u
#define Entrada__PRT CYREG_PRT3_PRT
#define Entrada__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define Entrada__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define Entrada__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define Entrada__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define Entrada__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define Entrada__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define Entrada__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define Entrada__PS CYREG_PRT3_PS
#define Entrada__SHIFT 3u
#define Entrada__SLW CYREG_PRT3_SLW
...
/* PulsoSensor */
#define PulsoSensor__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define PulsoSensor__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define PulsoSensor__INTC_MASK 0x01u
#define PulsoSensor__INTC_NUMBER 0u
#define PulsoSensor__INTC_PRIOR_NUM 7u
#define PulsoSensor__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define PulsoSensor__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define PulsoSensor__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* RXInterrupt */
#define RXInterrupt__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define RXInterrupt__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define RXInterrupt__INTC_MASK 0x02u
#define RXInterrupt__INTC_NUMBER 1u
#define RXInterrupt__INTC_PRIOR_NUM 7u
#define RXInterrupt__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define RXInterrupt__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define RXInterrupt__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* Temporizador */
#define Temporizador__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define Temporizador__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define Temporizador__INTC_MASK 0x04u
#define Temporizador__INTC_NUMBER 2u
#define Temporizador__INTC_PRIOR_NUM 7u
#define Temporizador__INTC_PRIOR_REG CYREG_NVIC_PRI_2
#define Temporizador__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define Temporizador__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
#define CYDEV_INTR_RISING 0x0000000Au
