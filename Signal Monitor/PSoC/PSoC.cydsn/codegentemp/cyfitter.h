...
/* senal */
#define senal__0__INTTYPE CYREG_PICU0_INTTYPE6
#define senal__0__MASK 0x40u
#define senal__0__PC CYREG_PRT0_PC6
#define senal__0__PORT 0u
#define senal__0__SHIFT 6u
#define senal__AG CYREG_PRT0_AG
#define senal__AMUX CYREG_PRT0_AMUX
#define senal__BIE CYREG_PRT0_BIE
#define senal__BIT_MASK CYREG_PRT0_BIT_MASK
#define senal__BYP CYREG_PRT0_BYP
#define senal__CTL CYREG_PRT0_CTL
#define senal__DM0 CYREG_PRT0_DM0
#define senal__DM1 CYREG_PRT0_DM1
#define senal__DM2 CYREG_PRT0_DM2
#define senal__DR CYREG_PRT0_DR
#define senal__INP_DIS CYREG_PRT0_INP_DIS
#define senal__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define senal__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define senal__LCD_EN CYREG_PRT0_LCD_EN
#define senal__MASK 0x40u
#define senal__PORT 0u
#define senal__PRT CYREG_PRT0_PRT
#define senal__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define senal__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define senal__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define senal__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define senal__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define senal__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define senal__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define senal__PS CYREG_PRT0_PS
#define senal__SHIFT 6u
#define senal__SLW CYREG_PRT0_SLW
