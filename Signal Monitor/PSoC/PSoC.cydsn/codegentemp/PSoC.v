// ======================================================================
// PSoC.v generated from TopDesign.cysch
// 01/11/2021 at 16:00
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("3ab18322-5970-4e5b-bf94-dc7756b7c13d/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__senal_net;
	wire [0:0] tmpFB_0__senal_net;
	wire [0:0] tmpIO_0__senal_net;
	wire [0:0] tmpINTERRUPT_0__senal_net;
	electrical [0:0] tmpSIOVREF__senal_net;
	...
	cy_psoc3_pins_v1_10
		...
		senal
		 (.oe(tmpOE__senal_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__senal_net[0:0]}),
		  .analog({Net_15}),
		  .io({tmpIO_0__senal_net[0:0]}),
		  .siovref(tmpSIOVREF__senal_net),
		  .interrupt({tmpINTERRUPT_0__senal_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__senal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
