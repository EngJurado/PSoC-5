...
/* DATA */
#define DATA__0__INTTYPE CYREG_PICU1_INTTYPE2
#define DATA__0__MASK 0x04u
#define DATA__0__PC CYREG_PRT1_PC2
#define DATA__0__PORT 1u
#define DATA__0__SHIFT 2u
#define DATA__AG CYREG_PRT1_AG
#define DATA__AMUX CYREG_PRT1_AMUX
#define DATA__BIE CYREG_PRT1_BIE
#define DATA__BIT_MASK CYREG_PRT1_BIT_MASK
#define DATA__BYP CYREG_PRT1_BYP
#define DATA__CTL CYREG_PRT1_CTL
#define DATA__DM0 CYREG_PRT1_DM0
#define DATA__DM1 CYREG_PRT1_DM1
#define DATA__DM2 CYREG_PRT1_DM2
#define DATA__DR CYREG_PRT1_DR
#define DATA__INP_DIS CYREG_PRT1_INP_DIS
#define DATA__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define DATA__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define DATA__LCD_EN CYREG_PRT1_LCD_EN
#define DATA__MASK 0x04u
#define DATA__PORT 1u
#define DATA__PRT CYREG_PRT1_PRT
#define DATA__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define DATA__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define DATA__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define DATA__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define DATA__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define DATA__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define DATA__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define DATA__PS CYREG_PRT1_PS
#define DATA__SHIFT 2u
#define DATA__SLW CYREG_PRT1_SLW
...
/* Contador_1 */
#define Contador_1_CounterHW__CAP0 CYREG_TMR0_CAP0
#define Contador_1_CounterHW__CAP1 CYREG_TMR0_CAP1
#define Contador_1_CounterHW__CFG0 CYREG_TMR0_CFG0
#define Contador_1_CounterHW__CFG1 CYREG_TMR0_CFG1
#define Contador_1_CounterHW__CFG2 CYREG_TMR0_CFG2
#define Contador_1_CounterHW__CNT_CMP0 CYREG_TMR0_CNT_CMP0
#define Contador_1_CounterHW__CNT_CMP1 CYREG_TMR0_CNT_CMP1
#define Contador_1_CounterHW__PER0 CYREG_TMR0_PER0
#define Contador_1_CounterHW__PER1 CYREG_TMR0_PER1
#define Contador_1_CounterHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define Contador_1_CounterHW__PM_ACT_MSK 0x01u
#define Contador_1_CounterHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define Contador_1_CounterHW__PM_STBY_MSK 0x01u
#define Contador_1_CounterHW__RT0 CYREG_TMR0_RT0
#define Contador_1_CounterHW__RT1 CYREG_TMR0_RT1
#define Contador_1_CounterHW__SR0 CYREG_TMR0_SR0

/* isr_counter */
#define isr_counter__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define isr_counter__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define isr_counter__INTC_MASK 0x01u
#define isr_counter__INTC_NUMBER 0u
#define isr_counter__INTC_PRIOR_NUM 7u
#define isr_counter__INTC_PRIOR_REG CYREG_NVIC_PRI_0
...
#define CY_PROJECT_NAME "Practica 9_TemperaturaYHumedad"
