// ======================================================================
// Practica 9_TemperaturaYHumedad.v generated from TopDesign.cysch
// 08/28/2021 at 17:55
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=9, CONTROL3=1, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=999, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Contador_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Contador_1, CY_INSTANCE_SHORT_NAME=Contador_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Contador_1, )
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c3d911cc-9b66-489c-96e1-4275feb19469/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    Counter_v3_0_0 Contador_1 (
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Contador_1.CaptureMode = 0;
    defparam Contador_1.ClockMode = 0;
    defparam Contador_1.CompareMode = 1;
    defparam Contador_1.CompareStatusEdgeSense = 1;
    defparam Contador_1.EnableMode = 0;
    defparam Contador_1.ReloadOnCapture = 0;
    defparam Contador_1.ReloadOnCompare = 0;
    defparam Contador_1.ReloadOnOverUnder = 1;
    defparam Contador_1.ReloadOnReset = 1;
    defparam Contador_1.Resolution = 16;
    defparam Contador_1.RunMode = 0;
    defparam Contador_1.UseInterrupt = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("8188af6a-eefd-4e9f-8574-93762f024828"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
